...
class OnOffApplication : public SourceApplication
{
  ...
  private:
    ...
    /**
     * @brief Send more data as soon as some buffer space is available.
     *
     * This callback is invoked when the socket has buffer space available.
     * It attempts to retry sending a previously cached unsent packet.
     *
     * @param socket the socket
     * @param availableBufferSize the available buffer size in bytes
     */

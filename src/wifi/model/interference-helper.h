 ...
 */
using RxPowerWattPerChannelBand = std::unordered_map<WifiSpectrumBandInfo, Watt_u>;
...
class InterferenceHelper : public Object
{
  ...
  protected:
     ...
     */
    using NiChangesPerBand = std::unordered_map<WifiSpectrumBandInfo, NiChanges>;

    /**
     * Map of first power per band
     */
    using FirstPowerPerBand = std::unordered_map<WifiSpectrumBandInfo, Watt_u>;

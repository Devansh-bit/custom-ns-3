                            ...
                            WifiActionHeader::ActionValue action)
{
    ...
    case WNM_TRANSITION_MANAGEMENT: {
        m_actionValue = static_cast<uint8_t>(action.wnmTransitionManagement);
        break;
    }
...
WifiActionHeader::GetCategory() const
{
    ...
    case WNM_TRANSITION_MANAGEMENT:
        return WNM_TRANSITION_MANAGEMENT;
    case VENDOR_SPECIFIC_ACTION:
...
WifiActionHeader::GetAction() const
{
    ...
    case WNM_TRANSITION_MANAGEMENT:
        switch(m_actionValue)
        {
            case BSS_TRANSITION_MGMT_REQUEST:
                retval.wnmTransitionManagement = BSS_TRANSITION_MGMT_REQUEST;
                break;
            case BSS_TRANSITION_MGMT_RESPONSE:
                retval.wnmTransitionManagement = BSS_TRANSITION_MGMT_RESPONSE;
                break;
            default:
                NS_FATAL_ERROR("Unknown BSS Transition Management Action Code");
        }
        break;

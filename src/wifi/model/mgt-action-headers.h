...
class WifiActionHeader : public Header
{
  public:
    ...
    enum CategoryValue : uint8_t // table 9-51 of IEEE 802.11-2020
    {
        ...
        WNM_TRANSITION_MANAGEMENT = 10, // Category: Transition Management
    ...
    enum WnmTransitionManagementValue : uint8_t
    {
        BSS_TRANSITION_MGMT_REQUEST = 7,
        BSS_TRANSITION_MGMT_RESPONSE = 8,
    };
    ...
    typedef union {
        ...
        WnmTransitionManagementValue wnmTransitionManagement;

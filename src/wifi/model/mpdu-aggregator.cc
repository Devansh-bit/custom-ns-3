                                ...
                                WifiModulationClass modulation) const
{
    ...
    if (modulation >= WIFI_MOD_CLASS_EHT)
    {
        if (!ehtCapabilities)
        {
            NS_LOG_DEBUG("EHT Capabilities not yet received for " << recipient
                         << ", disabling A-MPDU aggregation");
            return 0;
        }
    ...
    else if (modulation >= WIFI_MOD_CLASS_HE)
    {
        if (!heCapabilities)
        {
            NS_LOG_DEBUG("HE Capabilities not yet received for " << recipient
                         << ", disabling A-MPDU aggregation");
            return 0;
        }
    ...
    else if (modulation == WIFI_MOD_CLASS_VHT)
    {
        if (!vhtCapabilities)
        {
            NS_LOG_DEBUG("VHT Capabilities not yet received for " << recipient
                         << ", disabling A-MPDU aggregation");
            return 0;
        }
    ...
    else if (modulation == WIFI_MOD_CLASS_HT)
    {
        if (!htCapabilities)
        {
            NS_LOG_DEBUG("HT Capabilities not yet received for " << recipient
                         << ", disabling A-MPDU aggregation");
            return 0;
        }

...
{
  public:
    void SetCoordinatedChannelSwitch(bool coordinated);
    bool IsCoordinatedChannelSwitch() const;
     ...
     *
     * This base implementation applies the channel change to the current device only.
     * Derived classes (e.g., ApWifiMac) may override to add additional behavior such
     * as propagating channel changes to associated stations.
     */
  ...
  protected:
    ...
    bool m_coordinatedChannelSwitch{false};

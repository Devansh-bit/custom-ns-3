...
/// Coarse subcarrier frequency spacing for faster simulation (4x coarser than standard)
static constexpr uint32_t SUBCARRIER_FREQUENCY_SPACING_COARSE{1250000};
